...
def HomePage(request):
    return render(request,'pgpapp/home.html')
...
def SignupPage(request):
    ...
    if request.method == 'POST':
        ...
        if dataForm.is_valid():
            ...
            return render(request, 'pgpapp/signup.html', {'form': emptyForm})
    return render(request, 'pgpapp/signup.html', {'form': emptyForm, 'form1': emptyForm1})
...
def LoginPage(request):
    ...
    return render (request,'pgpapp/login.html')
...
def ImageModelForm(request):
    if request.method == 'POST':
        ...
        form = ImageForm()
    return render(request, 'pgpapp/imageform.html', {'form': form})
...
def modelform(request):
    if request.method == 'POST':
        ...
        form = PgModelform()
    return render(request, 'pgpapp/modelform.html', {'form': form})
...
def Showdata(request):
    if request.method == 'POST':
        ...
        return render(request, 'pgpapp/show.html', {'pg_data': pg_data, 'pgimage_data': pgimage_data, 'search': search})
    else:
        pg_data = PG.objects.all()
        pgimage_data = PGImage.objects.all()
        return render(request, 'pgpapp/show.html', {'pg_data': pg_data, 'pgimage_data': pgimage_data})

@login_required(login_url='login')
def complete(request,eno):
    s=PGImage.objects.get(id=eno)
    return render(request,'pgpapp/complete.html',{'data':s})
...
def userregister(request,eno):
    ...
    if vac>0:
        ...
        return redirect('showdata')
    return render(request,'pgpapp/register.html',{'obj':obj})
...
def showusers(request):
    ...
    return render(request,'pgpapp/showuser.html',{'data':data})
...
def pglogin(request):
    if request.method=='POST':
        ...
        if validuser != None:
            ...
            return redirect('pgpapp/pgloginurl')
    return render(request,'pgpapp/pglogin.html')
...
def pgsignuppage(request):
    ...
    if request.method == 'POST':
        ...
        if dataForm.is_valid():
            ...
            return render(request, 'pgpapp/pgsignup.html', {'form': emptyForm})
    return render(request, 'pgpapp/pgsignup.html', {'form': emptyForm, 'form1': emptyForm1})
